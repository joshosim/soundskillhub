...
export function Testimonials() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "I was introduced to Sound skill hub by my sons’ class teacher, his handwriting needed ‘an intervention’ and just two classes in and she already gave a positive feedback on the improvement she noticed in not just his writing but learning in general!! I am a grateful mum and I highly recommend",
      badge: true,
    },
    {
      name: 'Mrs. Ngozi Eze',
